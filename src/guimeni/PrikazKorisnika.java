...
public class PrikazKorisnika {
    ...
    public PrikazKorisnika(Korisnik prijvaljeniKor) throws ClassNotFoundException, SQLException {
        ...
        polja.getChildren().addAll(username, password, bankovni, adresa);
            ...
            try {
                ...
                if (alert.getResult() == ButtonType.YES) {
                    if (tblKor.usernameProvera(username.getText().replaceAll("\\s", "")) == false) {
                        ...
                        Korisnik k = new Korisnik(username.getText(), password.getText(), bankovni.getText(), adresa.getText());
        ...
        tv.setOnMouseClicked(e -> {
            if (tv.getSelectionModel().getSelectedItem() != null) {
                try {
                    ...
                    bankovni.setText(tblKor.listaKorisnika().get(tv.getSelectionModel().getSelectedIndex()).getBankovniRacun());
