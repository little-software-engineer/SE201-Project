 ...
 * @author PC
 */
public class PrikazRezervacija {

    public PrikazRezervacija(Korisnik prijvaljeniKor) throws ClassNotFoundException, SQLException {
        ...
        tblKor.RezervacijaTabel(tv, prijvaljeniKor);
